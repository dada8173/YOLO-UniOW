...
infer_type = "one2one"
"""
LocountOWOD 訓練配置 - 中等解凍 36% 版本
參數區塊、註解、結構與主解凍版一致，僅保留原有學習率、work_dir、frozen_stages、neck.freeze_all、bbox_head.freeze_one2many 等個別差異
"""
...
model = dict(
    ...
    backbone=dict(
        ...
        frozen_stages=3,  # ✅ 解凍最後2層 Stage 3,4 (36%)
    ),
    neck=dict(
        freeze_all=False,  # ✅ 解凍
    ),
